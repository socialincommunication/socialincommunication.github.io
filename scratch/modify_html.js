...
const filePath = '/Users/macbookretina/Downloads/SOCIALIN_SITO_WEB/fisiointegra-sistema-visivo/index.html';
const outputPath = '/Users/macbookretina/Downloads/SOCIALIN_SITO_WEB/fisiointegra-sistema-visivo/fisiointegra-sistema-visivo-completo.html';
...
`;
  if (!html.includes('class="sticky-menu"')) {
    html = html.replace('<body>', '<body>' + stickyMenuHtml);
  }
  ...
  const spotHtml = `
    ...
    <section class="sec" id="spot">
      ...
      <div class="method-note" style="margin-top:24px; border-left:4px solid var(--teal);">
...
`;
  if (!html.includes('id="spot"')) {
    html = html.replace('<!-- ============ 2. FEED PREVIEW ============ -->', spotHtml + '    <!-- ============ 2. FEED PREVIEW ============ -->');
  }

  // 6. Insert Dashboard, Prompt AI, Metodo
  const promptCommon = "<li>Mantenere palette FisioIntegra</li><li>Evitare stile ospedaliero</li><li>Evitare dolore estremo e scene drammatiche</li><li>Luce naturale, persone rilassate</li><li>Lasciare spazio negativo per i testi</li><li>No testo generato o watermark</li>";
...
`;
  if (!html.includes('id="dashboard"')) {
    html = html.replace('<section class="back-to-cases-section"', extraSectionsHtml + '\n    <section class="back-to-cases-section"');
  }
...
`;
  if (!html.includes('NOTA FINALE')) {
    html = html.replace('<!-- ============ CREDITS ============ -->', finalNoteHtml + '\n    <!-- ============ CREDITS ============ -->');
  }
