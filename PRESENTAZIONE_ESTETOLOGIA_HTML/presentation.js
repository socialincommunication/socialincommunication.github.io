document.addEventListener('DOMContentLoaded', () => {
  ...
  function goToSlide(index) {
    ...
    // Deactivate previous active slide
    ...
    // Sync URL hash without triggering hashchange scroll jump
  ...
  document.addEventListener('keydown', (e) => {
    // If index menu is focused, don't hijack keyboard inputs
  ...
  // Touch Swipe Navigation (for Tablet support)
  let touchStartX = 0;
  let touchEndX = 0;
